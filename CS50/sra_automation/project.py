...
Entrez.email = "Enter your Email"  # NCBI requires an email
Entrez.api_key = "Setup API from NCBI"# Optional for higher access limits
sra_toolkit_path = "ADD PATH OF SRA TOOLKIT"
...
def main():
    ...
    for accession in accessions:
        ...
        downloaded_files.extend([
            os.path.join("PATH", f"{accession}_1.fastq.gz"),
            os.path.join("PATH", f"{accession}_2.fastq.gz")
        ])
    print(accessions)
    ...
    output_dir = "PATH/fastqR"
    trimmed_dir = "PATH/trimmed"
    trimmed_fastqc_dir = "PATH/trimmed_fastqc"
